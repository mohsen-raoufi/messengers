clc;
clear all;
clearvars -except i_p2e i_p2m list_i_p2e list_i_p2m;
close all;
% 
% i_p2e = 36;
% i_p2m = 45;
...
% linkThresh = 0.4;
% linkThresh = 4*0.10; % the sensng range below which two nodes get connected
ArenaScale = 1.0;
...
% res_video_maker_paper_with_pot_f_homophily();
